...
require_once __DIR__.\DIRECTORY_SEPARATOR.'ProviderConfig'.\DIRECTORY_SEPARATOR.'SamlConfig.php';
...
class ProviderConfig 
{
    ...
    public function saml(array $value = []): \Symfony\Config\Security\ProviderConfig\SamlConfig
    {
        if (null === $this->saml) {
            $this->_usedProperties['saml'] = true;
            $this->saml = new \Symfony\Config\Security\ProviderConfig\SamlConfig($value);
        } elseif (0 < \func_num_args()) {
    ...
    public function __construct(array $value = [])
    {
        ...
        if (array_key_exists('saml', $value)) {
            $this->_usedProperties['saml'] = true;
            $this->saml = new \Symfony\Config\Security\ProviderConfig\SamlConfig($value['saml']);
            unset($value['saml']);
        }
