...
title=''  tabindex="-1"              
>
{if isset($fields.direction.value)}
...
<button type="button" id="{$fields.date_start.name}_trigger" class="btn calendarstart" onclick="return false;">		
