...
<span class="datetimeicon" id="{$fields.estimated_start_date.name}_trigger" onclick="return false;">
...
<span class="datetimeicon" id="{$fields.estimated_end_date.name}_trigger" onclick="return false;">
{sugar_getimage name="calendar" attr='border="0" ' alt="{$APP.LBL_ENTER_DATE}"}
</span>
</span>
<script type="text/javascript">
