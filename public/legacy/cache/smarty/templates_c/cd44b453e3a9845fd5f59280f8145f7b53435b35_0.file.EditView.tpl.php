...
/* Smarty version 4.5.3, created on 2025-03-07 13:50:52
  from 'C:\Apache24\htdocs\crm\public\legacy\cache\themes\suite8\modules\Calls\EditView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.3',
  'unifunc' => 'content_67caf9bc5dbd12_57049320',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'cd44b453e3a9845fd5f59280f8145f7b53435b35' => 
    array (
      0 => 'C:\\Apache24\\htdocs\\crm\\public\\legacy\\cache\\themes\\suite8\\modules\\Calls\\EditView.tpl',
      1 => 1741355452,
      2 => 'file',
    ),
  ),
  'includes' => 
  array (
    'file:modules/Reminders/tpls/reminders.tpl' => 1,
  ),
),false)) {
function content_67caf9bc5dbd12_57049320 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="button primary" onclick="SUGAR.calls.fill_invitees();document.EditView.action.value='Save'; document.EditView.return_action.value='DetailView'; <?php if ((isset($_REQUEST['isDuplicate'])) && $_REQUEST['isDuplicate'] == "true") {?>document.EditView.return_id.value=''; <?php }?>formSubmitCheck();;" type="button" name="button" value="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_SAVE_BUTTON_LABEL'];?>
"/>
...
" accessKey="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_CANCEL_BUTTON_KEY'];?>
" class="button" onclick="SUGAR.ajaxUI.loadContent('index.php?action=index&module=Calls'); return false;" type="button" name="button" value="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_CANCEL_BUTTON_LABEL'];?>
...
" id="CLOSE_CREATE_HEADER" accessKey="<?php echo $_smarty_tpl->tpl_vars['APP']->value['LBL_CLOSE_AND_CREATE_BUTTON_KEY'];?>
...
<select name="<?php echo $_smarty_tpl->tpl_vars['fields']->value['direction']['name'];?>
"
id="<?php echo $_smarty_tpl->tpl_vars['fields']->value['direction']['name'];?>
"
title=''  tabindex="-1"              
>
<?php if ((isset($_smarty_tpl->tpl_vars['fields']->value['direction']['value']))) {
echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['fields']->value['direction']['options'],'selected'=>$_smarty_tpl->tpl_vars['fields']->value['direction']['value']),$_smarty_tpl);?>

<?php } else {
echo smarty_function_html_options(array('options'=>$_smarty_tpl->tpl_vars['fields']->value['direction']['options'],'selected'=>$_smarty_tpl->tpl_vars['fields']->value['direction']['default']),$_smarty_tpl);?>
...
<div class="col-xs-12 col-sm-6 edit-view-row-item edit-view-bordered" data-field="parent_name">
...
ob_start();
$_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_LIST_RELATED_TO','module'=>'Calls'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
...
} else { ?>Accounts<?php }?>"],"group":"or","field_list":["name","id"],"populate_list":["parent_name","parent_id"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\u041d\u0435 \u0432\u044b\u0431\u0440\u0430\u043d\u043e"};<?php echo '</script'; ?>
>
<?php echo '<script'; ?>
>
...
<div class="col-xs-12 col-sm-12 edit-view-row-item" data-field="duration_hours">
...
<?php echo '<script'; ?>
 type="text/javascript">function isValidDuration() { form = document.getElementById('EditView'); if ( form.duration_hours.value + form.duration_minutes.value <= 0 ) { alert('<?php echo $_smarty_tpl->tpl_vars['MOD']->value['NOTICE_DURATION_TIME'];?>
'); return false; } return true; }<?php echo '</script'; ?>
><input tabindex="0"  id="duration_hours" name="duration_hours" size="2" maxlength="2" type="text" value="<?php echo $_smarty_tpl->tpl_vars['fields']->value['duration_hours']['value'];?>
" onkeyup="SugarWidgetScheduler.update_time();"/><?php echo $_smarty_tpl->tpl_vars['fields']->value['duration_minutes']['value'];?>
&nbsp;<span class="dateFormat"><?php echo $_smarty_tpl->tpl_vars['MOD']->value['LBL_HOURS_MINUTES'];?>
</span>
</div>
<div class="edit-dotted-border"></div>
...
<?php $_smarty_tpl->_subTemplateRender("file:modules/Reminders/tpls/reminders.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, false);
?>
</div>
<div class="edit-dotted-border"></div>
...
ob_start();
$_smarty_tpl->smarty->ext->_capture->open($_smarty_tpl, "label", "label", null);
echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO_NAME','module'=>'Calls'),$_smarty_tpl);
$_smarty_tpl->smarty->ext->_capture->close($_smarty_tpl);
echo smarty_modifier_strip_semicolon($_smarty_tpl->tpl_vars['label']->value);?>
:
...
function formSubmitCheck(){var duration=true;if(typeof(isValidDuration)!="undefined"){duration=isValidDuration();}if(check_form('EditView') && duration){SUGAR.ajaxUI.submitForm("EditView");}}<?php echo '</script'; ?>
>
...
<?php echo '<script'; ?>
 type="text/javascript">
addForm('EditView');addToValidate('EditView', 'name', 'name', true,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_SUBJECT','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
...
addToValidate('EditView', 'modified_user_id', 'assigned_user_name', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_MODIFIED','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'modified_by_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_MODIFIED_NAME','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'created_by', 'assigned_user_name', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CREATED','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'created_by_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CREATED','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'description', 'text', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_DESCRIPTION','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'deleted', 'bool', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_DELETED','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'assigned_user_id', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO_ID','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'assigned_user_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO_NAME','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'duration_hours', 'int', true,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_DURATION_HOURS','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'duration_minutes', 'int', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_DURATION_MINUTES','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'date_start_date', 'date', true,'Дата звонка' );
addToValidate('EditView', 'date_end_date', 'date', false,'Дата окончания' );
addToValidate('EditView', 'parent_type', 'parent_type', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_PARENT_TYPE','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'parent_name', 'parent', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_LIST_RELATED_TO','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'status', 'enum', true,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_STATUS','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'direction', 'enum', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_DIRECTION','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'parent_id', 'id', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_LIST_RELATED_TO_ID','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'reminder_checked', 'bool', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_REMINDER','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'reminder_time', 'enum', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_REMINDER_TIME','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'email_reminder_checked', 'bool', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_EMAIL_REMINDER','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'email_reminder_time', 'enum', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_EMAIL_REMINDER_TIME','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'email_reminder_sent', 'bool', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_EMAIL_REMINDER_SENT','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'reminders', 'function', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_REMINDER','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'outlook_id', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_OUTLOOK_ID','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'accept_status', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_ACCEPT_STATUS','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'set_accept_links', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_ACCEPT_LINK','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'contact_name', 'relate', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_CONTACT_NAME','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'repeat_type', 'enum', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_REPEAT_TYPE','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'repeat_interval', 'int', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_REPEAT_INTERVAL','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'repeat_dow', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_REPEAT_DOW','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'repeat_until', 'date', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_REPEAT_UNTIL','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'repeat_count', 'int', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_REPEAT_COUNT','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'repeat_parent_id', 'id', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_REPEAT_PARENT_ID','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'recurring_source', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_RECURRING_SOURCE','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'reschedule_history', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_RESCHEDULE_HISTORY','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidate('EditView', 'reschedule_count', 'varchar', false,'<?php echo smarty_function_sugar_translate(array('label'=>'LBL_RESCHEDULE_COUNT','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
' );
addToValidateBinaryDependency('EditView', 'assigned_user_name', 'alpha', false,'<?php echo smarty_function_sugar_translate(array('label'=>'ERR_SQS_NO_MATCH_FIELD','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
: <?php echo smarty_function_sugar_translate(array('label'=>'LBL_ASSIGNED_TO','module'=>'Calls','for_js'=>true),$_smarty_tpl);?>
', 'assigned_user_id' );
<?php echo '</script'; ?>
><?php echo '<script'; ?>
 language="javascript">if(typeof sqs_objects == 'undefined'){var sqs_objects = new Array;}sqs_objects['EditView_parent_name']={"form":"EditView","method":"query","modules":["Accounts"],"group":"or","field_list":["name","id"],"populate_list":["parent_name","parent_id"],"required_list":["parent_id"],"conditions":[{"name":"name","op":"like_custom","end":"%","value":""}],"order":"name","limit":"30","no_match_text":"\u041d\u0435 \u0432\u044b\u0431\u0440\u0430\u043d\u043e"};sqs_objects['EditView_assigned_user_name']={"form":"EditView","method":"get_user_array","field_list":["user_name","id"],"populate_list":["assigned_user_name","assigned_user_id"],"required_list":["assigned_user_id"],"conditions":[{"name":"user_name","op":"like_custom","end":"%","value":""}],"limit":"30","no_match_text":"\u041d\u0435 \u0432\u044b\u0431\u0440\u0430\u043d\u043e"};<?php echo '</script'; ?>
>
<?php }
}
